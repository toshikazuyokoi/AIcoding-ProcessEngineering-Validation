...
## 概要
backend/Dockerfileファイルを作成し、backend/Dockerfile作成・検証を実装します。
...
- [ ] コミットメッセージ作成: "feat(#007): backend/Dockerfile作成・検証"
- [ ] git commit実行
- [ ] リモートリポジトリへのプッシュ
...
- **Phase**: Phase 0
- **カテゴリ**: Docker環境
- **タスクID**: TSK-007-ENV-backend-dockerfile